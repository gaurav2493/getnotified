...
<header class="navbar navbar-bright navbar-fixed-top" role="banner">
  <div class="container">
    <div class="navbar-header">
      ...
      <a href="/" class="navbar-brand">Get Notified</a>
    </div>
...
<div id="masthead">  
  <div class="container">
      <div class="row">
        <div class="col-md-7">
          <h1>Hello
            <p class="lead">A Quick Brown fox jumped over the lazy dog</p>
          </h1>
        </div>
        <div class="col-md-5">
               ...
               Hello haha
                  ...
                  <div class="col-md-6">
                    <div class="panel panel-default">
                      ...
                      <div class="panel-body">kjxcvjnbxkjc
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                      <div class="panel panel-default">
                      <div class="panel-heading"><h3>Hello.</h3></div>
                      <div class="panel-body">fxgfxcfbxcb
                      </div>
                    </div>
                  </div>  
              	</div>
                ...
                Testing 1243t5
              	...
              	<hr>
              <h4><a href="http://bootply.com/75781">Do Somethong</a></h4>
              	<hr>
